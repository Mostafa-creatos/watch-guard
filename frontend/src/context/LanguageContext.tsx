...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    confirmLeaveGroup: "Are you sure you want to leave this group? If you are the last member, the group will be deleted.",
    leaveGroupBalanceWarning: "You cannot leave this group because you have unsettled balances!",
    confirmSettleUp: "Are you sure you want to record this repayment?",
    download: "Download",
    hello: "Hello",
  ...
  fr: {
    ...
    confirmLeaveGroup: "Êtes-vous sûr de vouloir quitter ce groupe ? Si vous êtes le dernier membre, le groupe sera supprimé.",
    leaveGroupBalanceWarning: "Vous ne pouvez pas quitter ce groupe car vous avez des soldes non réglés !",
    confirmSettleUp: "Êtes-vous sûr de vouloir enregistrer ce remboursement ?",
    hello: "Bonjour",
  ...
  ar: {
    ...
    confirmLeaveGroup: "هل أنت متأكد أنك تريد مغادرة هذه المجموعة؟ إذا كنت آخر عضو، فسيتم حذف المجموعة.",
    leaveGroupBalanceWarning: "لا يمكنك مغادرة هذه المجموعة لأن لديك أرصدة غير مسواة!",
    confirmSettleUp: "هل أنت متأكد أنك تريد تسجيل هذا السداد؟",
    hello: "مرحباً",
